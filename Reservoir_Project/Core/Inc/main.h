...
#define DIGIT_A0_Pin GPIO_PIN_4
#define DIGIT_A0_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define DIGIT_A3_Pin GPIO_PIN_6
#define DIGIT_A3_GPIO_Port GPIOA
#define DIGIT_B0_Pin GPIO_PIN_0
...
#define DIGIT_B1_Pin GPIO_PIN_4
#define DIGIT_B1_GPIO_Port GPIOB
#define DIGIT_B2_Pin GPIO_PIN_5
#define DIGIT_B2_GPIO_Port GPIOB
#define DIGIT_B3_Pin GPIO_PIN_6
#define DIGIT_B3_GPIO_Port GPIOB
#define DIGIT_A1_Pin GPIO_PIN_8
#define DIGIT_A1_GPIO_Port GPIOB
#define DIGIT_A2_Pin GPIO_PIN_9
