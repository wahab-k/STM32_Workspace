...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|BLU_Pin|RED_Pin|GRN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin BLU_Pin RED_Pin GRN_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|BLU_Pin|RED_Pin|GRN_Pin;
